...
export default function AdminProductEdit() {
  ...
  useEffect(() => {
    (async () => {
      ...
      setForm(found ? ({ ...found, images: found.images ?? [] } as Product) : null);
      setLoading(false);
    })();
  }, [id]);
  ...
  // Display in KSh: we now store **shillings**, not cents
  ...
  return (
    <AdminLayout title="Edit Product" subtitle={form.title}>
      ...
      <form id="product-edit-form" onSubmit={save} className="grid gap-5 lg:grid-cols-3 lg:items-start">
        {/* Left */}
        <div className="lg:col-span-2 space-y-5 min-w-0">
          {/* Basics */}
          <div className="card-soft p-5 space-y-4">
            <SectionTitle title="Basics" hint="Update the core details customers see first." />
          ...
          {/* Pricing & Stock */}
          <div className="card-soft p-5 space-y-4">
            <SectionTitle title="Pricing & Stock" hint="Keep pricing accurate and inventory up to date." />
            <div className="grid gap-3 sm:grid-cols-3">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      // store **shillings** (rounded to whole KSh)
          ...
          {/* Images */}
          <div className="card-soft p-5 space-y-4">
            <SectionTitle title="Images" hint="First image is the cover. Upload or paste a link." />
            ...
            <p className="text-xs text-gray-500">
              Local files are stored as optimized previews (data URLs). For production, upload to storage and save the returned URL.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-3 hidden lg:block">
          <div className="card-soft p-5 space-y-3 sticky top-6">
            ...
            <div className="text-xs text-gray-500">
              You can reorder images and edit details any time.
            </div>
          </div>
        </div>
      </form>
